...
return [
     ...
     */
    'apis' => [
        'Klaus' => __DIR__ . '/app/api.php'
    ],

    /**
     * The view paths to register.
     *
     * E.G: 'Klaus' => __DIR__ . '/views'
     * can be referenced via @Klaus/
     * when rendering a view in twig.
     */
    'views' => [
        'Klaus' => __DIR__ . '/resources/views'
    ],
